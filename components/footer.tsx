        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/projects/ak-shanyraq" className="text-sm text-primary-foreground/70 transition-colors hover:text-primary-foreground">
                {"ЖК «Ак Шанырак»"}
              </Link>
              <Link href="/projects/baitas" className="text-sm text-primary-foreground/70 transition-colors hover:text-primary-foreground">
                ЖК BAITAS
              </Link>
